...
if image:
    ...
    info.markdown("<h2 style= 'text-align: center;'>Information</h>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style= 'text-align: center;'>Resizing</h>", unsafe_allow_html=True)
    width=st.number_input("Width", value=img.width)
    height=st.number_input("Height", value=img.height)
    st.markdown("<h2 style= 'text-align: center;'>Rotation</h>", unsafe_allow_html=True)
